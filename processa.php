...
'$COD_E_DESCRICAO_DA_ATIVIDADE_ECONÔMICAS_SECUNDÁRIAS',
...
list($INSCRICAO,$DATA_DE_ABERTURA,$NOME_EMPRESARIAL,$NOME_FANTASIA,$COD_E_DESCRICAO_DA_ATIVIDADE_ECONOMICA_PRINCIPAL,$COD_E_DESCRICAO_DA_ATIVIDADE_ECON,$COD_E_DESCRICAO_DA_NATUREZA_JURIDICA,$LOGRADOURO,$NUMERO,$COMPLEMENTO,$CEP,$BAIRRO,$MUNICIPIO,$UF,$EMAIL,$TEL,$EFR,$SITUACAO_CADASTRAL,$DATA_DA_SITUACAO_CADASTRAL,$MOTIVO_DE_SITUACAO_CADASTRAL,$SITUACAO_ESPECIAL,$DATA_DA_SITUACAO_ESPECIAL) = $campos;


var_dump($COD_E_DESCRICAO_DA_ATIVIDADE_ECON);
